...
/**
 * Created by francisbingo on 3/12/21 11:52 AM
 * <p>
 * sp存储工具类
 */
public class SharedPrefUtil {
    ...
    public SharedPrefUtil(@NonNull Context context) {
        preferences = context.getSharedPreferences("bingo_sp", Context.MODE_PRIVATE);
        editor = preferences.edit();
    }

    public SharedPrefUtil(@NonNull Context context, String name) {
